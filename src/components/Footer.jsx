...
const socialLinks = [
  ...
  {
    name: 'Email',
    href: 'mailto:anshu04232@gmail.com',
    color: '#3b82f6',
    icon: 'M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 8.118h-18.879l5.613-8.113zm9.201-1.259l4.623-3.746v9.458l-4.623-5.712z',
  },
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/anshhu04',
    color: '#e4405f',
